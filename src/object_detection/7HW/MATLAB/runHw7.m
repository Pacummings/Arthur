...
signAcademicHonestyPolicy('Gabriel Elkind', 'pp1917');
...
% grid_MN = [20, 20];              % Number of rows and cols in the grid
search_half_window_size = 30;   % Half size of the search window
template_half_window_size = 20; % Half size of the template window 
...
% to specify the target of interest
%  %tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [156 132 43 45];

% Half size of the search window
%tracking_params.search_half_window_size = 55;
...
% to specify the target of interest
%tracking_params.rect = chooseTarget(data_params);
 tracking_params.rect = [361 115 17 15];

% Half size of the search window
tracking_params.search_half_window_size = 15;
% Number of bins in the color histogram
 tracking_params.bin_n = 0;           
